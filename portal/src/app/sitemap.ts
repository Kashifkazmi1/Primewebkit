...
const staticRoutes = [
  ...
  { path: "/guides/ai-chatbot-for-customer-support", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/guides/ai-chatbot-for-lead-generation", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/guides/what-is-a-rag-chatbot", priority: 0.8, changeFrequency: "monthly" as const },
